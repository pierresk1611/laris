                      ...
                      <div className="max-w-[200px]">
                        ...
                        <div className="flex flex-wrap gap-1 mt-1">
                          {order.items?.[0]?.templateKey && order.items?.[0]?.templateId ? (
                            <span className="px-1.5 py-0.5 bg-green-100 text-green-700 rounded text-[9px] font-black uppercase flex items-center gap-1 border border-green-200" title={`Napárované na šablónu: ${order.items[0].templateName || order.items[0].templateKey}`}>
                              ✓ {order.items[0].templateName || order.items[0].templateKey}
                            </span>
                          ) : (
